...
df=pd.read_csv('/content/weatherAUSnew.csv', encoding='utf-8')
...
## Output:
''' 
<img width="660" height="499" alt="download" src="https://github.com/user-attachments/assets/5bf8f3de-767f-4dca-8d5b-1bc68edea84d" />
